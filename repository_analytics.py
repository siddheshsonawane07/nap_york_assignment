...
# @st.cache_data
# def load_data():
#     """Load and preprocess Repository dataset."""
...
#     repo_languages = ["All"] + sorted(df["primary_language"].dropna().unique().tolist())
#     selected_language = st.sidebar.selectbox("Select Language", repo_languages)
